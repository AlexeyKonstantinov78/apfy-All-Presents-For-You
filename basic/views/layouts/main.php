...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <?php $this->head() ?>
		<meta name="verify-admitad" content="5a924b7f9a" />
    </head>
    <body>
    <?php $this->beginBody() ?>
    <section id="top_bar">
            ...
            <section class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-6 text-right top_phone_mail">
                        <a class="g_phone" onclick="goog_report_conversion ('tel:8 (495) 199-18-25')" href="tel:+79999999">+7 999 999 99 99</a>
                        <span class="hidden-xs">/</span>
                        <a
                                class="g_mail hidden-xs"
                                href="mailto:info@sadf.ru">info@sadf.ru</a>
        ...
        <section class="container">
            <div class="row footer_info">
                <div class="col-xs-6 col-lg-4 footer_info_block">
                    ...
                    <a class="transition_02 footer_link" target="_blank" href="/page/delivery">
                        Доставка и оплата
                    </a><br/>
                ...
                <div class="col-xs-12 col-sm-6 footer_info_block">
                    ...
                    <a target="_blank" href="/page/karta-halva" style="margin: 5px; display:inline-block"><img src="/img/site/halva/cart/cartSize.png" alt="Прием карт халвы" /></a><br/>
                    <a target="_blank" href="https://vk.com/biznes_podarki_apfy" title="Бизнес-подарки" target="_blank"><img src="/img/site/icons/vk_icon.png" style="max-width: 44px; width:100%" alt="Бизнес-подарки" /></a>
                    <a target="_blank" href="https://webmaster.yandex.ru/sqi?host=apfy.ru" style="margin: 5px; display:inline-block"><img width="88" height="31" alt="" border="0" src="https://yandex.ru/cycounter?apfy.ru&theme=light&lang=ru"/></a>
                </div>
