...
<style>
    ...
    .grid-view table tr td:last-child a:first-child {
        display: none;
    }
    ...
    .grid-view table tr td:nth-child(9) {
        color: red;
        font-weight: bold;
        font-size: 15px
    }
...
<div class="product-index">
    ...
    echo GridView::widget([
        ...
        'pager' => [
            ...
            'maxButtonCount'=>20,  // вот тут количество кнопок
        ],
        'tableOptions' => [
        ...
        'columns' => [
            ...
            [
                'attribute' => 'active',
                //'filter' => Html::activeDropDownList($searchModel, 'active', $active),
                'label' => 'Статус товара',
                'value' => function($model, $key, $index) {
                    ...
                    /*return Html::tag('span', $active[$model['active']], [
                            'style' => 'color:red'
                    ]);*/
                },
            ],
