...
//            'products_yml' => $products_yml,
//        ]);
        $data = $this->renderPartial('ecatalog', [
            'treeCat' => $treeCat,
            'products_yml' => $products_yml,
        ]);
        $src = '/var/www/apfy.ru/web/eCatalog.xml';
        file_put_contents($src, $data);
        return $this->goHome();
    }
    ...
    public function actionPrice()
    {
       ...
       //var_dump(count($products_ymlAr)); exit;
        $products_yml = $products_ymlAr;
...
//        exit;
        ...
        $idProducts =  array("2687", "2688", "2689", "2690", "2691", "4019", "4289", "4290", "4291", "4292", "4293", "4294", "4295", "4296", "4297", "4298", "4299", "4300", "4301", "4302", "4303", "4304", "4305", "4306", "4307", "4308", "4309", "4310", "4311", "4312", "5048", "5049", "5050", "5051", "5052", "5215", "5216", "5217", "5218", "5219", "5305", "5306", "5307", "5308", "5315", "5316", "5317", "5318", "5319", "5320", "5321", "5322", "5323", "5324", "5325", "5326", "5327", "5328", "5329", "5330", "5331", "5332", "5333", "5334", "5335", "5336", "5337", "5338", "5339", "5340", "5341", "5342", "5343", "5344", "5345", "5346", "5347", "5348", "5349", "5350", "5351", "5352", "5353", "5354", "5355", "5356", "5749", "4100" );
        foreach ($products as $k=>$v){
            if($v['price'] < 1000) Continue;
...
//        exit;
		...
		//*/
        $dataSmall = $this->renderPartial('marketPenAllSmall', [
            'treeCat' => $treeCat,
            'products_yml' => $products_yml,
        ]);
        ...
        $srcSmall = '/var/www/apfy.ru/web/marketPenAllSmall.xml';
        $src = '/var/www/apfy.ru/web/marketAllPen.xml';

		//echo $data; exit;
        file_put_contents($srcSmall, $dataSmall);
        file_put_contents($src, $data);
        return $this->goHome();
    }
	
    public function actionMarketthermos()
    {
        //https://apfy.ru/marketPen.xml

        //вывод категорий
        $category = new Category();
        $treeCat = $category->generateTreeCatParent(1126);
		//var_dump($treeCat); exit;
...
//        exit;
        ...
        foreach ($products as $k=>$v){
            ...
            if(!in_array(1126,$product_test) ) Continue;
            //ищем последнюю категорию
            //$lastCatBrands проблеема в последних категориях, с ними что то не так
            $lastCat = Yii::$app->cache->get('lastCatProduct'.$v['id']);
            $products = false; //отключить кеш
...
//        exit;
        ...
        $src = '/var/www/apfy.ru/web/marketThermos.xml';
    ...
    public function actionMarketstanley()
    {
        //https://apfy.ru/marketPen.xml

        //вывод категорий
        $category = new Category();
        $treeCat = $category->generateTreeCatParent(1135);
		//var_dump($treeCat); exit;
...
//        exit;
        ...
        foreach ($products as $k=>$v){
            ...
            if(!in_array(1135,$product_test) ) Continue;
            //ищем последнюю категорию
            //$lastCatBrands проблеема в последних категориях, с ними что то не так
            $lastCat = Yii::$app->cache->get('lastCatProduct'.$v['id']);
            $products = false; //отключить кеш
...
//        exit;
		...
		//*/
        $data = $this->renderPartial('marketStanley', [
            'treeCat' => $treeCat,
            'products_yml' => $products_yml,
        ]);
        $src = '/var/www/apfy.ru/web/marketStanley.xml';
