...
$this->registerCssFile('/css/site/pagesCss/filter.css');
...
?>
<button class="tab-filter__button tab-filter__button--absolute tab-filter__button-absolute-top">
	Фильтранем?!)
</button>
<aside class="col-lg-3 transition_02 filter-off">
